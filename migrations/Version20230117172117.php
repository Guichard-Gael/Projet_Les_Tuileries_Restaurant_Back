 ...
 */
final class Version20230117172117 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE page_content_picture (page_content_id INT NOT NULL, picture_id INT NOT NULL, INDEX IDX_A56499E48F409273 (page_content_id), INDEX IDX_A56499E4EE45BDBF (picture_id), PRIMARY KEY(page_content_id, picture_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
